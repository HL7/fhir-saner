...
//* coding 1..*
* coding contains ResourceType 1..1 MS and Snomed 1..* MS
...
* group 0..* MS
* group.extension contains MeasureGroupAttributes named groupAtts 1..1 MS
* group.extension[groupAtts] ^short = "Describes the attributes of one or more sections of the measure (form) being reported"

* group.extension[MeasureGroupAttributes].extension[scoring].valueCodeableConcept 1..1 MS
...
* group.extension[MeasureGroupAttributes].extension[type].valueCodeableConcept 1..1  MS
