...
InstanceOf: SearchParameter
Title: "Search by hospitalization.dischargeDisposition in Encounters"
Usage: #definition
* insert SanerDefinitionContent
...
* base[0] = #Encounter
* type = #token
* expression = "hospitalization.dischargeDisposition"

* xpath = "f:hospitalization/f:dischargeDisposition"
* xpathUsage = #normal
* multipleOr = true
* multipleAnd = false
