...
* relatedArtifact[0].type = LIBTYPE#documentation
...
* relatedArtifact[1].type = LIBTYPE#documentation
...
* relatedArtifact[2].type = LIBTYPE#documentation
...
* relatedArtifact[3].type = LIBTYPE#documentation
...
* url = "http://hl7.org/fhir/uv/saner/StructureDefinition/NHSNMeasureLibrary"
...
* group[0].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[0].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[0].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[0].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Location
* group[0].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#91537007
...
* group[0].population[0].code = MEASVALS#numTotBeds
...
* group[0].population[1].code.coding = MEASVALS#numbeds
* group[0].population[1].code.coding.display = "Hospital Inpatient Beds"
// * group[0].population[1].code.coding[1] = MEASPOP#measure-population
...
* group[0].population[2].code.coding = MEASVALS#numBedsOcc
...
// * group[0].population[2].code.coding[1] = MEASPOP#measure-population
...
* group[0].population[3].code.coding = MEASVALS#numICUBeds
* group[0].population[3].code.coding.display = "ICU Beds"
* group[0].population[3].code.text = "ICU Bed Occupancy"
// * group[0].population[3].code.coding[1] = MEASPOP#measure-population
...
* group[0].population[4].code.coding = MEASVALS#numICUBedsOcc
* group[0].population[4].code.coding.display = "ICU Bed Occupancy"
// * group[0].population[4].code.coding[1] = MEASPOP#measure-population
...
* group[1].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[1].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[1].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#decrease
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#706172005
...
* group[1].population[0].code.coding = MEASVALS#numVent
...
* group[1].population[1].code.coding = MEASVALS#numVentUse
* group[1].population[1].code.coding.display = "Mechanical Ventilators in Use"
// * group[1].population[1].code.coding[1] = MEASPOP#measure-population
...
* group[2].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[2].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[2].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#decrease
* group[2].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Encounter
* group[2].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#308335008
...
* group[2].population[0].code.coding = MEASVALS#numC19HospPats
* group[2].population[0].code.coding.display = "Hospitalized COVID-19 Patients"
// * group[2].population[0].code.coding[1] = MEASPOP#measure-population
...
* group[2].population[1].code.coding = MEASVALS#numC19MechVentPats
* group[2].population[1].code.coding.display = "Hospitalized and Ventilated COVID-19 Patients"
// * group[2].population[1].code.coding[1] = MEASPOP#measure-population
...
* group[2].population[2].code.coding = MEASVALS#numC19HOPats
* group[2].population[2].code.coding.display = "Hospital Onset COVID-19 Patients"
// * group[2].population[2].code.coding[1] = MEASPOP#measure-population
...
* group[2].population[3].code.coding = MEASVALS#numC19OverflowPats
* group[2].population[3].code.coding.display = "ED/Overflow COVID-19 Patients"
// * group[2].population[3].code.coding[1] = MEASPOP#measure-population
...
* group[2].population[4].code.coding = MEASVALS#numC19OFMechVentPats
* group[2].population[4].code.coding.display = "ED/Overflow and Ventilated COVID-19 Patients"
// * group[2].population[4].code.coding[1] = MEASPOP#measure-population
...
* group[2].population[4].criteria.expression = "%numC19OverflowPats.intersect(%numC19VentPats)" 
* group[2].population[5].criteria.name = "numC19Died"

// Describe the criteria for numC19Died
* group[2].population[5].code.coding = MEASVALS#numC19Died
* group[2].population[5].code.coding.display = "COVID-19 Patient Deaths"
// * group[2].population[5].code.coding[1] = MEASPOP#measure-population
...
* group[2].population[6].code.coding = MEASVALS#numC19Pats
* group[2].population[6].code.coding.display = "All COVID-19 Confirmed or Suspected Patients"
* group[2].population[6].code.coding[1] = MEASPOP#initial-population
...
* group[2].population[7].code.coding = MEASVALS#numC19VentPats
* group[2].population[7].code.coding.display = "Ventilated COVID-19 Patients"
// * group[2].population[7].code.coding[1] = MEASPOP#measure-population
...
* meta.profile[1] = "http://hl7.org/fhir/uv/saner/StructureDefinition/PublicHealthMeasure"
* url = "http://hl7.org/fhir/uv/saner/Measure/CDCHealthcareSupplyPathway"
* version = "0.1.0"
...
* relatedArtifact.type = LIBTYPE#documentation
...
* relatedArtifact[4].type = LIBTYPE#documentation
...
* relatedArtifact[5].type = LIBTYPE#documentation
...
* type.coding = MTYPE#composite
* group.extension[groupAtts].extension[scoring].valueCodeableConcept.coding = SCORING#continuous-variable
* group.extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group.extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#706172005
* group.extension[groupAtts].extension[subject].valueCodeableConcept.text = "Mechanical Ventilators"
* group.extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group.extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#decrease
...
* group.population[0].code.coding = MEASVALS#ventsupply
...
* group.population[1].code.coding = MEASVALS#ventreuse
...
* group.population[2].code.coding = MEASVALS#ventobtain
...
* group[1].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#409532003
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.text = "N95 Masks"
* group[1].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[1].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[1].extension[groupAtts].extension[rateAggregation].valueString = "count"

* group[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#N95Masks
* group[1].code.text = "N95 Mask Supply Reporting"
* group[1].population[0].code.coding = MEASVALS#n95masksupply
...
* group[1].population[1].code.coding = MEASVALS#n95maskreuse
...
* group[1].population[2].code.coding = MEASVALS#n95maskobtain
...
* group[2].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[2].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group[2].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#277973009
* group[2].extension[groupAtts].extension[subject].valueCodeableConcept.text = "Other Respirator Equipment"
* group[2].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[2].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[2].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#OtherRespirators
* group[2].code.text = "Other Respirator Supply Reporting"

* group[2].population[0].code.coding = MEASVALS#othrespsupply
...
* group[2].population[1].code.coding = MEASVALS#othrespreuse
...
* group[2].population[2].code.coding = MEASVALS#othrespobtain
...
* group[3].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[3].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group[3].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#409528009
...
* group[3].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[3].extension[groupAtts].extension[rateAggregation].valueString = "count"

* group[3].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#SurgicalMasks
* group[3].code.text = "Surgical Mask Supply Reporting"

* group[3].population[0].code.coding = MEASVALS#surgmasksupply
...
* group[3].population[1].code.coding = MEASVALS#surgmaskreuse
...
* group[3].population[2].code.coding = MEASVALS#surgmaskobtain
...
* group[4].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[4].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group[4].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#38126007
...
* group[4].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[4].extension[groupAtts].extension[rateAggregation].valueString = "count"

* group[4].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#EyeProtection
* group[4].code.text = "Eye Protection Supply Reporting"

* group[4].population[0].code.coding = MEASVALS#shieldsupply
...
* group[4].population[1].code.coding = MEASVALS#shieldreuse
...
* group[4].population[2].code.coding = MEASVALS#shieldobtain
...
* group[5].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[5].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group[5].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#409527004
* group[5].extension[groupAtts].extension[subject].valueCodeableConcept.text = "Gowns"
* group[5].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[5].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[5].extension[groupAtts].extension[rateAggregation].valueString = "count"

* group[5].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#Gown
* group[5].code.text = "Gown Supply Reporting"

* group[5].population[0].code.coding = MEASVALS#gownsupply
...
* group[5].population[1].code.coding = MEASVALS#gownreuse
...
* group[5].population[2].code.coding = MEASVALS#gownobtain
...
* group[6].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[6].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Device
* group[6].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#52291003
* group[6].extension[groupAtts].extension[subject].valueCodeableConcept.text = "Gloves"
* group[6].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[6].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[6].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[6].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#Glove
* group[6].code.text = "Glove Supply Reporting"

* group[6].population[0].code.coding = MEASVALS#glovesupply
...
* group[6].population[2].code.coding = MEASVALS#gloveobtain
...
* meta.profile = "http://hl7.org/fhir/StructureDefinition/Measure"
* meta.profile[1] = "http://hl7.org/fhir/uv/saner/StructureDefinition/PublicHealthMeasure"
* url = "http://hl7.org/fhir/uv/saner/Measure/CDCHealthcareWorkerStaffingPathway"
* version = "0.1.0"
...
* library = Canonical(NHSNMeasureLibrary)
* type.coding = MTYPE#composite
* group.extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group.extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group.extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group.extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#45956004
...
* group.extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group.extension[groupAtts].extension[rateAggregation].valueString = "count"
* group.code.coding = MEASVALS#shortenvsvc
* group.code.text = "Front-line persons who clean patient rooms and all areas in a healthcare facility"
* group.population.code.coding = SPECTYPE#true
...
* group.population[1].code.coding = SPECTYPE#false
...
* group[1].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[1].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#106293008
...
* group[1].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[1].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[1].code.coding = MEASVALS#shortnurse
* group[1].code.text = "Registered nurses and licensed practical nurses"
* group[1].population.code.coding = SPECTYPE#true
...
* group[1].population[1].code.coding = SPECTYPE#false
...
* group[2].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[2].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[2].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[2].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#442867008
...
* group[2].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[2].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[2].code.coding = MEASVALS#shortrt
...
* group[2].population.code.coding = SPECTYPE#true
...
* group[2].population[1].code.coding = SPECTYPE#false
...
* group[3].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[3].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[3].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[3].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#46255001
...
* group[3].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[3].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[3].code.coding = MEASVALS#shortphar
* group[3].code.text = "Pharmacists and pharmacy techs"
* group[3].population.code.coding = SPECTYPE#true
...
* group[3].population[1].code.coding = SPECTYPE#false
...
* group[4].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[4].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[4].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[4].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#309343006
...
* group[4].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[4].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[4].code.coding = MEASVALS#shortphys
* group[4].code.text = "Attending physicians, fellows"
* group[4].population.code.coding = SPECTYPE#true
...
* group[4].population[1].code.coding = SPECTYPE#false
...
* group[5].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[5].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[5].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[5].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#405623001
...
* group[5].population[1].code.coding = SPECTYPE#false
...
* group[6].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[6].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[6].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[6].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#33738006
...
* group[6].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[6].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[6].code.coding = MEASVALS#shortoth
...
* group[6].population.code.coding = SPECTYPE#true
...
* group[6].population[1].code.coding = SPECTYPE#false
...
* group[7].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[7].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[7].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[7].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#158965000
...
* group[7].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[7].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[7].code.coding = MEASVALS#shortothlic
* group[7].code.text = "Advanced practice nurses, physician assistants"
* group[7].population.code.coding = SPECTYPE#true
...
* group[7].population[1].code.coding = SPECTYPE#false
...
* group[8].extension[groupAtts].extension[scoring].valueCodeableConcept = SCORING#continuous-variable
* group[8].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#structure
* group[8].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#Practitioner
* group[8].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#106375005
* group[8].extension[groupAtts].extension[subject].valueCodeableConcept.text = "Cleaning Staff"
* group[8].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#increase
* group[8].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[8].code.coding = MEASVALS#posshortenvsvc
* group[8].code.text = "Front-line persons who clean patient rooms and all areas in a healthcare facility"
* group[8].population.code.coding = SPECTYPE#true
...
* group[8].population[1].code.coding = SPECTYPE#false
...
* group[9].code.coding = MEASVALS#posshortnurse
* group[9].code.text = "Registered nurses and licensed practical nurses"
* group[9].population.code.coding = SPECTYPE#true
...
* group[9].population[1].code.coding = SPECTYPE#false
...
* group[10].code.coding = MEASVALS#posshortrt
...
* group[10].population.code.coding = SPECTYPE#true
...
* group[10].population[1].code.coding = SPECTYPE#false
...
* group[11].code.coding = MEASVALS#posshortphar
* group[11].code.text = "Pharmacists and pharmacy techs"
* group[11].population.code.coding = SPECTYPE#true
...
* group[11].population[1].code.coding = SPECTYPE#false
...
* group[12].code.coding = MEASVALS#posshortphys
* group[12].code.text = "Attending physicians, fellows"
* group[12].population.code.coding = SPECTYPE#true
...
* group[12].population[1].code.coding = SPECTYPE#false
...
* group[13].population[1].code.coding = SPECTYPE#false
...
* group[14].code.coding = MEASVALS#posshortoth
...
* group[14].population.code.coding = SPECTYPE#true
...
* group[14].population[1].code.coding = SPECTYPE#false
...
* group[15].code.coding = MEASVALS#posshortothlic
* group[15].code.text = "Advanced practice nurses, physician assistants"
* group[15].population.code.coding = SPECTYPE#true
...
* group[15].population[1].code.coding = SPECTYPE#false
