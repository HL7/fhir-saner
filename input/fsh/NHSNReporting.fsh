...
* group[0].population[0].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numTotBeds
...
* group[0].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numbeds
...
* group[0].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numBedsOcc
...
* group[0].population[3].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numICUBeds
...
* group[0].population[4].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numICUBedsOcc
...
* group[1].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numVent
...
* group[1].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numVentUse
...
* group[2].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19HospPats
...
* group[2].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19MechVentPats
...
* group[2].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19HOPats
...
* group[2].population[3].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19OverflowPats
...
* group[2].population[4].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19OFMechVentPats
...
* group[2].population[5].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19Died
...
* group[2].population[6].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19Pats
...
* group[2].population[7].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19VentPats
...
* relatedArtifact.type = http://terminology.hl7.org/CodeSystem/library-type#documentation
...
* relatedArtifact[4].type = http://terminology.hl7.org/CodeSystem/library-type#documentation
...
* relatedArtifact[5].type = http://terminology.hl7.org/CodeSystem/library-type#documentation
...
* group.population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#ventsupply
...
* group.population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#ventreuse
...
* group.population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#ventobtain
...
* group[1].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#n95masksupply
...
* group[1].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#n95maskreuse
...
* group[1].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#n95maskobtain
...
* group[2].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#othrespsupply
...
* group[2].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#othrespreuse
...
* group[2].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#othrespobtain
...
* group[3].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#surgmasksupply
...
* group[3].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#surgmaskreuse
...
* group[3].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#surgmaskobtain
...
* group[4].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shieldsupply
...
* group[4].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shieldreuse
...
* group[4].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shieldobtain
...
* group[5].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gownsupply
...
* group[5].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gownreuse
...
* group[5].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gownobtain
...
* group[6].population[0].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#glovesupply
...
* group[6].population[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#glovereuse
...
* group[6].population[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gloveobtain
...
* group.extension[groupAtts].extension[rateAggregation].valueString = "count"
* group.code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortenvsvc
...
* group[1].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#increase
* group[1].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortnurse
...
* group[2].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#increase
* group[2].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortrt
...
* group[3].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#increase
* group[3].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[3].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortphar
...
* group[4].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#increase
* group[4].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[4].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortphys
...
* group[5].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#increase
* group[5].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[5].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shorttemp
...
* group[6].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/measure-improvement-notation#increase
* group[6].extension[groupAtts].extension[rateAggregation].valueString = "count"
* group[6].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortoth
...
* group[7].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortothlic
...
* group[8].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortenvsvc
...
* group[9].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortnurse
...
* group[10].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortrt
...
* group[11].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortphar
...
* group[12].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortphys
...
* group[13].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshorttemp
...
* group[14].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortoth
...
* group[15].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortothlic
