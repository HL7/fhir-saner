...
* useContext.valueCodeableConcept = SCT#840539006 "COVID-19"
* type = MTYPE#outcome
* topic = SCT#252318005 "Immunology laboratory test (procedure)"
...
* group[0].extension[groupAtts].extension[type].valueCodeableConcept = MTYPE#outcome
* group[0].extension[groupAtts].extension[improvementNotation].valueCodeableConcept = MESIMP#decrease
* group[0].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#ServiceRequest
* group[0].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#252318005
...
* group[0].population[1].code.coding[1] = MEASPOP#denominator
...
* group[0].population[2].code.coding[1] = MEASPOP#numerator
...
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[ResourceType] = RESTYPE#ServiceRequest
* group[1].extension[groupAtts].extension[subject].valueCodeableConcept.coding[Snomed] = SCT#252318005
...
* group[1].population[1].code.coding[1] = MEASPOP#denominator-exclusion
...
* group[1].population[3].code.coding[1] = MEASPOP#numerator
...
// * group[1].population[4].code.coding[1] = MEASPOP#measure-population
...
// * group[1].population[5].code.coding[1] = MEASPOP#measure-population
