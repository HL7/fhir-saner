...
* url = "http://hl7.org/fhir/uv/saner/Questionnaire/CDCPatientImpactAndHospitalCapacity"
* version = "0.1.0"
...
* item.item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#facilityId
* item.item.text = "Facility ID #:"
* item.item.type = "string"
* item.item.required = true
* item.item.repeats = false
* item.item[1].linkId = "summaryCensusId"
* item.item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#summaryCensusId
...
* item.item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#collectionDate
...
* item[1].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19HospPats
...
* item[1].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19MechVentPats
...
* item[1].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19HOPats
...
* item[1].item[3].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19OverflowPats
...
* item[1].item[4].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19OFMechVentPats
...
* item[1].item[5].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numC19Died
...
* item[2].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numTotBeds
...
* item[2].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numbeds
...
* item[2].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numBedsOcc
...
* item[2].item[3].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numICUBeds
...
* item[2].item[4].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numICUBedsOcc
...
* item[2].item[5].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numVent
...
* item[2].item[6].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#numVentUse
...
* meta.profile = "http://hl7.org/fhir/StructureDefinition/Questionnaire"
* url = "http://hl7.org/fhir/uv/saner/Questionnaire/CDCHealthcareSupplyPathway"
* version = "0.1.0"
...
* item[2].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#ventsupply
...
* item[2].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#ventreuse
...
* item[2].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#ventobtain
...
* item[3].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#n95masksupply
...
* item[3].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#n95maskreuse
...
* item[3].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#n95maskobtain
...
* item[4].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#othrespsupply
...
* item[4].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#othrespreuse
...
* item[4].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#othrespobtain
...
* item[5].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#surgmasksupply
...
* item[5].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#surgmaskreuse
...
* item[6].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shieldsupply
...
* item[6].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shieldreuse
...
* item[6].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shieldobtain
...
* item[7].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gownsupply
...
* item[7].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gownreuse
...
* item[7].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gownobtain
...
* item[8].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#glovesupply
...
* item[8].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#glovereuse
...
* item[8].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#gloveobtain
...
* meta.profile = "http://hl7.org/fhir/StructureDefinition/Questionnaire"
* url = "http://hl7.org/fhir/uv/saner/Questionnaire/CDCHealthcareWorkerStaffingPathway"
* version = "0.1.0"
...
* item[2].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortenvsvc
* item[2].item.text = "Critical Staffing Shortage Today"
* item[2].item.type = "boolean"
* item[2].item.required = false
* item[2].item.repeats = false
* item[2].item[1].linkId = "posshortenvsvc"
* item[2].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortenvsvc
...
* item[3].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortnurse
* item[3].item.text = "Critical Staffing Shortage Today"
* item[3].item.type = "boolean"
* item[3].item.required = false
* item[3].item.repeats = false
* item[3].item[1].linkId = "posshortnurse"
* item[3].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortnurse
...
* item[4].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortrt
* item[4].item.text = "Critical Staffing Shortage Today"
* item[4].item.type = "boolean"
* item[4].item.required = false
* item[4].item.repeats = false
* item[4].item[1].linkId = "posshortrt"
* item[4].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortrt
...
* item[5].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortphar
* item[5].item.text = "Critical Staffing Shortage Today"
* item[5].item.type = "boolean"
* item[5].item.required = false
* item[5].item.repeats = false
* item[5].item[1].linkId = "posshortphar"
* item[5].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortphar
...
* item[6].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortphys
* item[6].item.text = "Critical Staffing Shortage Today"
* item[6].item.type = "boolean"
* item[6].item.required = false
* item[6].item.repeats = false
* item[6].item[1].linkId = "posshortphys"
* item[6].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortphys
...
* item[7].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shorttemp
* item[7].item.text = "Critical Staffing Shortage Today"
* item[7].item.type = "boolean"
* item[7].item.required = false
* item[7].item.repeats = false
* item[7].item[1].linkId = "posshorttemp"
* item[7].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshorttemp
...
* item[8].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortothlic
* item[8].item.text = "Critical Staffing Shortage Today"
* item[8].item.type = "boolean"
* item[8].item.required = false
* item[8].item.repeats = false
* item[8].item[1].linkId = "posshortothlic"
* item[8].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortothlic
...
* item[9].item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortoth
...
* item[9].item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#shortothsfy
...
* item[9].item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortoth
...
* item[9].item[3].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#posshortothsfy
...
* meta.profile = "http://hl7.org/fhir/StructureDefinition/Questionnaire"
* url = "http://hl7.org/fhir/uv/saner/Questionnaire/FEMADailyHospitalCOVID19Reporting"
* version = "0.1.0"
...
* item.item.code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#collectionDate
* item.item.text = "Date:"
* item.item.type = "date"
* item.item.required = true
* item.item.repeats = false
* item.item[1].linkId = "state"
* item.item[1].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#state
* item.item[1].text = "State:"
* item.item[1].type = "string"
* item.item[1].required = false
* item.item[1].repeats = false
* item.item[2].linkId = "county"
* item.item[2].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#county
* item.item[2].text = "County:"
* item.item[2].type = "string"
* item.item[2].required = false
* item.item[2].repeats = false
* item.item[3].linkId = "totalOrdersIncrease"
* item.item[3].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#totalOrdersIncrease
...
* item.item[4].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#totalOrders
...
* item.item[5].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#totalTestResultsIncrease
...
* item.item[6].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#rejected
...
* item.item[7].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#totalTestResults
...
* item.item[8].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#positiveIncrease
...
* item.item[9].code = http://hl7.org/fhir/uv/saner/CodeSystem/MeasuredValues#positive
