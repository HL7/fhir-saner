...
* group[1].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#Ventilators
...
* group[2].code.coding = http://hl7.org/fhir/uv/saner/CodeSystem/MeasureGroupSystem#Encounters
