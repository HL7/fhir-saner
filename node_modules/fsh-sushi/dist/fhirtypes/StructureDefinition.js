...
class StructureDefinition {
    ...
    toJSON(snapshot = true) {
        ...
        for (const prop of PROPS) {
            ...
            if (this[prop] !== undefined) {
                // @ts-ignore
                j[prop] = cloneDeep_1.default(this[prop]);
            }
        }
        ...
        j.differential.element = j.differential.element.filter((e) => {
            var _a, _b;
            return (
            // not a choice, or
            !e.id.endsWith('[x]') ||
                ...
                !(Object.keys(e).length === 3 &&
                    e.id &&
                    e.path &&
                    ((_b = (_a = e.slicing) === null || _a === void 0 ? void 0 : _a.discriminator) === null || _b === void 0 ? void 0 : _b.length) === 1 &&
    ...
    static fromJSON(json, captureOriginalElements = true) {
        ...
        for (const prop of PROPS) {
            ...
            if (json[prop] !== undefined) {
                // @ts-ignore
                sd[prop] = cloneDeep_1.default(json[prop]);
            }
        }
     ...
     */
    validateValueAtPath(path, value, fisher, units = false) {
        ...
        for (const pathPart of pathParts) {
            ...
            const arrayIndex = common_1.getArrayIndex(pathPart);
            if (arrayIndex != null) {
            ...
            const nonArrayElementIsBasedOnArray = ((_c = (_b = currentElement) === null || _b === void 0 ? void 0 : _b.base) === null || _c === void 0 ? void 0 : _c.max) !== '0' &&
                ((_e = (_d = currentElement) === null || _d === void 0 ? void 0 : _d.base) === null || _e === void 0 ? void 0 : _e.max) !== '1' &&
                (((_f = currentElement) === null || _f === void 0 ? void 0 : _f.max) === '0' || ((_g = currentElement) === null || _g === void 0 ? void 0 : _g.max) === '1');
            if (!currentElement ||
            ...
            if (((_h = currentElement.type) === null || _h === void 0 ? void 0 : _h.length) === 1 &&
     ...
     */
    parseFSHPath(fshPath) {
        const pathParts = [];
        const splitPath = common_1.splitOnPathPeriods(fshPath);
    ...
    sliceMatchingValueX(fhirPath, elements) {
        ...
        const matchingXElements = elements.filter(e => {
            ...
            if (e.path.endsWith('[x]')) {
                for (const t of (_a = e.type, (_a !== null && _a !== void 0 ? _a : []))) {
                    if (`${e.path.slice(0, -3)}${upperFirst_1.default(t.code)}` === fhirPath) {
                        matchingType = t;
                        return true;
                    }
                }
     ...
     */
    findMatchingSlice(pathPart, elements, fisher) {
        var _a, _b;
        ...
        if (!matchingSlice && ((_a = pathPart.brackets) === null || _a === void 0 ? void 0 : _a.length) === 1) {
            ...
            if ((_b = sliceDefinition) === null || _b === void 0 ? void 0 : _b.url) {
                matchingSlice = elements.find(e => { var _a, _b; return ((_b = (_a = e.type) === null || _a === void 0 ? void 0 : _a[0].profile) === null || _b === void 0 ? void 0 : _b[0]) === sliceDefinition.url; });
            }
        }
    ...
    findObsoleteChoices(baseElement, oldTypes) {
        ...
        oldTypes.forEach(oldType => {
            matchedThings.push(...choiceElements.filter(e => {
                return e.sliceName == `${desiredSliceName}${upperFirst_1.default(oldType.code)}` && e.hasDiff();
            }));
        });
     ...
     */
    findMatchingRef(pathPart, elements) {
...
utils_1.applyMixins(StructureDefinition, [common_1.HasName, common_1.HasId]);
/**
