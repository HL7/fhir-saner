...
* url = "http://hl7.org/fhir/us/saner/Questionnaire/CDCPatientImpactAndHospitalCapacity"
* version = "0.1.0"
...
* item.item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#facilityId
* item.item.text = "Facility ID #:"
* item.item.type = "string"
* item.item.required = true
* item.item.repeats = false
* item.item[1].linkId = "summaryCensusId"
* item.item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#summaryCensusId
...
* item.item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#collectionDate
...
* item[1].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numC19HospPats
...
* item[1].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numC19MechVentPats
...
* item[1].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numC19HOPats
...
* item[1].item[3].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numC19OverflowPats
...
* item[1].item[4].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numC19OFMechVentPats
...
* item[1].item[5].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numC19Died
...
* item[2].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numTotBeds
...
* item[2].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numbeds
...
* item[2].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numBedsOcc
...
* item[2].item[3].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numICUBeds
...
* item[2].item[4].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numICUBedsOcc
...
* item[2].item[5].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numVent
...
* item[2].item[6].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#numVentUse
...
* item[2].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#ventsupply
...
* item[2].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#ventreuse
...
* item[2].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#ventobtain
...
* item[3].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#n95masksupply
...
* item[3].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#n95maskreuse
...
* item[3].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#n95maskobtain
...
* item[4].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#othrespsupply
...
* item[4].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#othrespreuse
...
* item[4].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#othrespobtain
...
* item[5].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#surgmasksupply
...
* item[5].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#surgmaskreuse
...
* item[6].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shieldsupply
...
* item[6].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shieldreuse
...
* item[6].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shieldobtain
...
* item[7].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#gownsupply
...
* item[7].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#gownreuse
...
* item[7].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#gownobtain
...
* item[8].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#glovesupply
...
* item[8].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#glovereuse
...
* item[8].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#gloveobtain
...
* item[2].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortenvsvc
* item[2].item.text = "Critical Staffing Shortage Today"
* item[2].item.type = "boolean"
* item[2].item.required = false
* item[2].item.repeats = false
* item[2].item[1].linkId = "posshortenvsvc"
* item[2].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortenvsvc
...
* item[3].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortnurse
* item[3].item.text = "Critical Staffing Shortage Today"
* item[3].item.type = "boolean"
* item[3].item.required = false
* item[3].item.repeats = false
* item[3].item[1].linkId = "posshortnurse"
* item[3].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortnurse
...
* item[4].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortrt
* item[4].item.text = "Critical Staffing Shortage Today"
* item[4].item.type = "boolean"
* item[4].item.required = false
* item[4].item.repeats = false
* item[4].item[1].linkId = "posshortrt"
* item[4].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortrt
...
* item[5].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortphar
* item[5].item.text = "Critical Staffing Shortage Today"
* item[5].item.type = "boolean"
* item[5].item.required = false
* item[5].item.repeats = false
* item[5].item[1].linkId = "posshortphar"
* item[5].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortphar
...
* item[6].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortphys
* item[6].item.text = "Critical Staffing Shortage Today"
* item[6].item.type = "boolean"
* item[6].item.required = false
* item[6].item.repeats = false
* item[6].item[1].linkId = "posshortphys"
* item[6].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortphys
...
* item[7].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shorttemp
* item[7].item.text = "Critical Staffing Shortage Today"
* item[7].item.type = "boolean"
* item[7].item.required = false
* item[7].item.repeats = false
* item[7].item[1].linkId = "posshorttemp"
* item[7].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshorttemp
...
* item[8].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortothlic
* item[8].item.text = "Critical Staffing Shortage Today"
* item[8].item.type = "boolean"
* item[8].item.required = false
* item[8].item.repeats = false
* item[8].item[1].linkId = "posshortothlic"
* item[8].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortothlic
...
* item[9].item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortoth
...
* item[9].item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#shortothsfy
...
* item[9].item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortoth
...
* item[9].item[3].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#posshortothsfy
...
* item.item.code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#collectionDate
* item.item.text = "Date:"
* item.item.type = "date"
* item.item.required = true
* item.item.repeats = false
* item.item[1].linkId = "state"
* item.item[1].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#state
* item.item[1].text = "State:"
* item.item[1].type = "string"
* item.item[1].required = false
* item.item[1].repeats = false
* item.item[2].linkId = "county"
* item.item[2].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#county
* item.item[2].text = "County:"
* item.item[2].type = "string"
* item.item[2].required = false
* item.item[2].repeats = false
* item.item[3].linkId = "totalOrdersIncrease"
* item.item[3].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#totalOrdersIncrease
...
* item.item[4].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#totalOrders
...
* item.item[5].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#totalTestResultsIncrease
...
* item.item[6].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#rejected
...
* item.item[7].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#totalTestResults
...
* item.item[8].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#positiveIncrease
...
* item.item[9].code = http://hl7.org/fhir/us/saner/CodeSystem/MeasurePopulationSystem#positive
