...
Instance: MeasureConsumer-API-Pull
InstanceOf: CapabilityStatementWithSlices
Usage: #definition
Description: "Defines the additional requirements for the Measure Consumer implementing the API Option and the Pull Option."
* insert SanerDefinitionContent
* name = "MeasureConsumer_API_Pull"
* title = "Measure Consumer implementing the API Option and the Pull Option."
