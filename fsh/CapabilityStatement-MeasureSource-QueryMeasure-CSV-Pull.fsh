...
* rest[serverSlice].resource[MeasureReportSlice].operation[0].definition = "http://hl7.org/fhir/uv/fhir-saner/OperationDefinition/MeasureReport-read-csv"
...
* rest[serverSlice].resource[MeasureReportSlice].operation[1].definition = "http://hl7.org/fhir/uv/fhir-saner/OperationDefinition/MeasureReport-search-csv"
