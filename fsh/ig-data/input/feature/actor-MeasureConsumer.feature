...
Feature: MeasureConsumer-2 A Measure Consumer that implements the API and Push Options shall provide a CapabilityStatement when queried via [base]/metadata.