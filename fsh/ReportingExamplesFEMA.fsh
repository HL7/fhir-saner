RuleSet: NJExamplesFEMA
   * status = #complete
   * type = #summary
   * measure = "http://hl7.org/fhir/saner/Measure/FEMADailyHospitalCOVID19Reporting"
...
* group.code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasureGroupSystem#positiveIncreasePercent
* group.population.code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasuredValues#totalOrdersIncrease
...
* group.population[1].code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasuredValues#totalTestResultsIncrease
...
* group.population[2].code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasuredValues#positiveIncrease
...
* group[1].code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasureGroupSystem#positivePercent
* group[1].population.code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasuredValues#totalOrders
...
* group[1].population[1].code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasuredValues#rejected
...
* group[1].population[2].code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasuredValues#totalTestResults
...
* group[1].population[3].code.coding = http://hl7.org/fhir/saner/CodeSystem/MeasuredValues#positive
