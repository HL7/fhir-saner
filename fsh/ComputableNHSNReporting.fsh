 ...
 * group[0].extension[groupAtts].extension[scoring].valueCodeableConcept = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/PublicHealthMeasureScoring#queue-length
 ...
 * group[0].extension[groupAtts].extension[rateAggregation].valueString = "point-in-time"
 ...
 //** with code do
 * group[0].population[0].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numC19Pats
 ...
 * group[1].extension[groupAtts].extension[scoring].valueCodeableConcept = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/PublicHealthMeasureScoring#event-growth
 ...
 * group[1].population[0].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numC19HospPats
 ...
 * group[1].population[1].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numC19HOPats
 ...
 * group[1].population[2].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#cumC19HOPats
 ...
 * group[2].extension[groupAtts].extension[scoring].valueCodeableConcept = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/PublicHealthMeasureScoring#event-growth
 ...
 * group[2].population[0].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numC19Pats
 ...
 * group[2].population[1].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numC19Died
 ...
 * group[2].population[2].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#cumC19Died
 ...
 * group[3].extension[groupAtts].extension[scoring].valueCodeableConcept = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/PublicHealthMeasureScoring#capacity
 ...
 * group[3].population[0].code.coding[0] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numVent "Mechanical Ventilators"
 ...
 * group[3].population[1].code.coding[0] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numVentUse "Mechanical Ventilators in Use"
 ...
 * group[3].population[2].code.coding[0] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numVentAvail "Mechanical Ventilators Available"
 * group[3].population[2].code.coding[1] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasurePopulationSystem#numerator-complement
 ...
 * group[4].extension[groupAtts].extension[scoring].valueCodeableConcept = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/PublicHealthMeasureScoring#capacity
 ...
 * group[4].population[0].code.coding[0] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numTotBeds "All Hospital Beds"
 ...
 * group[4].population[1].code.coding[0] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numTotBedsOcc "Hospital Beds Occupied"
 ...
 * group[4].population[2].code.coding[0] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasuredValues#numTotBedsAvail "Hospital Beds Available"
 * group[4].population[2].code.coding[1] = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasurePopulationSystem#numerator-complement
