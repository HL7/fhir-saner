...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 139774
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 144021
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 151830
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 157449
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 162536
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 170688
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 178057
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 184826
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 191659
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 200148
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 205962
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
...
* group[1].population[4].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#totalTestResults
* group[1].population[4].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#denominator
* group[1].population[4].count = 213686
* group[1].population[5].code.coding = http://hl7.org/fhir/us/saner/CodeSystem/PopulationSystem#positive
* group[1].population[5].code.coding[1] = http://terminology.hl7.org/CodeSystem/measure-population#numerator
