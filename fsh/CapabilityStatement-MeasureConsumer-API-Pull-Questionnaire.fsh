...
Instance: MeasureConsumer-API-Pull-Questionnaire
InstanceOf: CapabilityStatementWithSlices
Usage: #definition
Description: "Defines the additional requirements for the Measure Consumer implementing the API Option, the Pull Option, and the Questionnaire Option."
* insert SanerDefinitionContent
* name = "MeasureConsumer_API_Pull_Questionnaire"
* title = "Measure Consumer implementing the API Option, the Pull Option, and the Questionnaire Option."
