...
Instance: MeasureSource-QueryMeasure-API-Pull
InstanceOf: CapabilityStatementWithSlices
Usage: #definition
Description: "Defines the additional requirements for the Measure Source implementing the Query Measure transaction with the API Option and the Pull Option."
* insert SanerDefinitionContent
* name = "MeasureSource_QueryMeasure_API_Pull"
* title = "Measure Source implementing the Query Measure transaction with the API Option and the Pull Option."
