...
Instance: MeasureSource-QueryMeasure-API-Pull-Questionnaire
InstanceOf: CapabilityStatementWithSlices
Usage: #definition
Description: "Defines the additional requirements for the Measure Source implementing the Query Measure transaction with the API Option, the Pull Option, and the Questionnaire Option."
* insert SanerDefinitionContent
* name = "MeasureSource_QueryMeasure_API_Pull_Questionnaire"
* title = "Measure Source implementing the Query Measure transaction with the API Option, the Pull Option, and the Questionnaire Option."
