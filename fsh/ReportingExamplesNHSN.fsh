RuleSet: NJExamplesNHSN
   * status = #complete
   * type = #summary
   * measure = "http://hl7.org/fhir/uv/fhir-saner/Measure/CDCPatientImpactAndHospitalCapacity"
...
* group.code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasureGroupSystem#Beds
...
* group[1].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasureGroupSystem#Ventilators
...
* group[2].code.coding = http://hl7.org/fhir/uv/fhir-saner/CodeSystem/MeasureGroupSystem#Encounters
